...
const data2 = __1.SimpleDataMapper.toCamelCase(data1);
const data3 = __1.SimpleDataMapper.toSnakeCase(data1);
const data4 = __1.SimpleDataMapper.toLowerCase(data1);
const data5 = __1.SimpleDataMapper.toUpperCase(data1);
